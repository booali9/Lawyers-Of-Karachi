      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.footerCol}>
          <div className={styles.footerBrand}>
            <span className={styles.footerBrandName}>Karachi Legal House</span>
            <span className={styles.footerBrandTagline}>Advocates &amp; Legal Consultants</span>
          </div>
        ...
        <div className={styles.footerCol}>
          ...
          <address className={styles.address}>
            ...
            <div className={styles.contactItem}>
              ...
              <p>
                <a href="tel:+923112610683">+92 311 2610683</a><br/>
